...
def generate_skill_demand_chart(skill_counts: Dict[str, int], output_path: str | Path) -> str:
    ...
    # Customize labels
    ax.set_xlabel('Number of Mentions', fontsize=11, color='#4b5563', weight='500', labelpad=10)
    ax.set_ylabel('')
    
    # Style tick labels
    plt.xticks(fontsize=10, color='#6b7280')
    plt.yticks(fontsize=12, color='#1f2937', weight='bold')
    
    # Add Title
    plt.title('Top 10 Most In-Demand Skills Today', fontsize=16, color='#111827', weight='900', pad=15, loc='left')
